      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-display text-5xl font-bold leading-tight mb-6" style={{ color: "#F0F0FF" }}>
            Get Referred.<br />
            <span style={{ color: "#6C63FF" }}>Get Hired.</span>
          </h1>
          ...
          <div className="flex flex-col gap-6">
            {[
              { icon: "✓", title: "Verified Referrers", desc: "Every referrer is verified with work email authentication" },
              { icon: "🔒", title: "Escrow Protection", desc: "Payment held securely until referral is confirmed" },
              { icon: "⚡", title: "Fast Results", desc: "Get your referral submitted within 48 hours or full refund" },
            ].map((point) => (
